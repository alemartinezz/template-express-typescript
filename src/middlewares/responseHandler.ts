...
export const HttpResponse = {
	...
	NonAuthoritativeInformation: new ApiResponse(203, 'Non-authoritative Information', 'The request has succeeded but the returned meta-information in the response is from the origin server, not the original client.'),
	...
	Unauthorized: new ApiResponse(401, 'Unauthorized', 'The request was a legal request, but the server is refusing to respond to it. For use when authentication is possible but has failed or not yet been provided.'),
